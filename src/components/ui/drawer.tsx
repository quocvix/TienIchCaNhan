  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        style={{
          maxHeight: "calc(var(--vv-height, 100vh) * 0.9)",
          ...style,
        }}
        {...props}
      >
...
function DrawerFooter({ className, style, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-col gap-2 p-4 transition-[padding] duration-150", className)}
      style={{
        paddingBottom: "calc(1rem + var(--vv-bottom-offset, 0px))",
        ...style,
      }}
      {...props}
    />
